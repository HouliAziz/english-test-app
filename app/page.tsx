          ...
          <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-xl p-6 text-white">
            ...
            <div className="mt-4 flex items-center space-x-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-semibold">{user.totalScore} points</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <Card className="animate-slide-up">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-2">3 of 4 lessons completed</p>
            </CardContent>
          </Card>
          ...
          <Card className="animate-slide-up" style={{ animationDelay: '0.1s' }}>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-600">12/15</div>
              <Progress value={80} className="mt-2" />
              <p className="text-xs text-muted-foreground mt-2">Lessons this week</p>
            </CardContent>
          </Card>
          ...
          <Card className="animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-2">250 points to go</p>
            </CardContent>
          </Card>
        </div>
